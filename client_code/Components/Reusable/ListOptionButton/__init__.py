...
from ._anvil_designer import ListOptionButtonTemplate
from anvil import HtmlTemplate
from ....utils import Properties


class ListOptionButton(ListOptionButtonTemplate):
  ...
  def _on_cleanup(self, **event_args):
    self.dom_nodes["app-button-component"].removeEventListener(
